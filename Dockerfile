...
RUN ( curl -s -L http://dl.mercurylang.org/${MERCURY_PREFIX}/mercury-srcdist-${MERCURY_STABLE_VERSION}.tar.gz | tar xz --strip 1 ) && sh configure --enable-csharp-grade --enable-erlang-grade --enable-java-grade
